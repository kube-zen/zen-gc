...
kubectl annotate garbagecollectionpolicy <policy-name> -n <namespace> gc.k8s.io/paused=true
...
```bash
# List CRD versions
kubectl get crd garbagecollectionpolicies.gc.k8s.io -o yaml | grep -A 5 "versions:"
